...
@Api(tags = "CO相关接口")
@RestController
@RequestMapping("/coGasInform")
public class CoGasInformController {

    @Resource
    private ICoGasInformService service;
    ...
    @GetMapping("/list")
    public BaseResp<List<CoGasInform>> getMonitorLatestData(String beginTime, String endTime) {
