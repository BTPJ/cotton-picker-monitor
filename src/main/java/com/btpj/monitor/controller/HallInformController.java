...
@Api(tags = "转速相关接口")
@RestController
@RequestMapping("/hallInform")
public class HallInformController {

    @Resource
    private IHallInformService service;
    ...
    @GetMapping("/list")
    public BaseResp<List<HallInform>> getMonitorLatestData(String beginTime, String endTime) {
