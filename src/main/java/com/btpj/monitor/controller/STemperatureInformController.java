...
@Api(tags = "温度相关接口")
@RestController
@RequestMapping("/temperatureInform")
public class STemperatureInformController {

    @Resource
    private ISTemperatureInformService service;
    ...
    @GetMapping("/list")
    public BaseResp<List<STemperatureInform>> getMonitorLatestData(String beginTime, String endTime) {
        return BaseResp.success(service.getList(beginTime, endTime), "获取历史监测数据成功");
    }
}
