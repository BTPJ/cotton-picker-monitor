...
@Api(tags = "水位相关接口")
@RestController
@RequestMapping("/waterLevelInform")
public class WaterLevelInformController {

    @Resource
    private IWaterLevelInformService service;
    ...
    @GetMapping("/list")
    public BaseResp<List<WaterLevelInform>> getMonitorLatestData(String beginTime, String endTime) {
